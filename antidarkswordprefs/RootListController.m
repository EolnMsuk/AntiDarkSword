...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        [decoyGroup setProperty:@"Spoofs the Corellium environment to cause advanced exploits (like Coruna) to self-abort — all four daemons are automatically re-enabled and locked when this is on to ensure full coverage." forKey:@"footerText"];
